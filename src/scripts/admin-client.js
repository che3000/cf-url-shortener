...
const form = requireEl($id("create-form"), "#create-form");
const msg = requireEl($id("create-msg"), "#create-msg");
const tbody = requireEl($id("list-body"), "#list-body");
const btnRefresh = requireEl($id("refresh"), "#refresh");
const listCount = requireEl($id("list-count"), "#list-count");
const btnPrev = requireEl($id("prev"), "#prev");
const btnNext = requireEl($id("next"), "#next");
const pageInfo = requireEl($id("page-info"), "#page-info");
const editModal = requireEl($id("edit-modal"), "#edit-modal");
const modalEnabled = requireEl($id("modal-interstitial-enabled"), "#modal-interstitial-enabled");
const modalSeconds = requireEl($id("modal-interstitial-seconds"), "#modal-interstitial-seconds");
const modalTtlHours = requireEl($id("modal-ttl-hours"), "#modal-ttl-hours");
const modalCancel = requireEl($id("modal-cancel"), "#modal-cancel");
const modalSave = requireEl($id("modal-save"), "#modal-save");
...
async function loadAllLinks(cursor = null) {
	const params = new URLSearchParams({ limit: "200", expand: "1" });
